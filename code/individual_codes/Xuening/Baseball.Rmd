...
```{r}
# Read the datasets
pitching2019 <- read_excel("2019Washington_Pitching_Individual.xlsx")
batting2019 <- read_excel("2019Washington_Batting_Individual.xlsx")

pitching2023 <- read_excel("2023Washington_Pitching_Individual.xlsx")
batting2023 <- read_excel("2023Washington_Batting_Individual.xlsx")
